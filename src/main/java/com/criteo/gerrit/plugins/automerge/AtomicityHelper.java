...
public class AtomicityHelper {
  ...
  public boolean hasDependentReview(String project, int number)
      throws IOException, NoSuchChangeException, NoSuchProjectException, StorageException,
   ...
   * @throws StorageException
   */
  public boolean isSubmittable(String project, int change) throws StorageException {
